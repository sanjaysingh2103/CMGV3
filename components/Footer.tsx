    ...
    <footer className="gradient-footer text-white">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 pt-16 pb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="mt-5 inline-flex items-center gap-2 bg-white/10 rounded-xl px-3 py-2">
              <div className="w-6 h-6 rounded-full bg-cmg-gold flex items-center justify-center">
                <span className="text-xs font-bold text-cmg-navy">M</span>
              </div>
              <div className="text-xs">
                <p className="font-semibold">MARA Registered</p>
                <p className="text-white/60">MARN {site.maraNumber}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/50">
          <p>© {year} {site.name}. All rights reserved. ABN {site.abn}</p>
          <div className="flex gap-4">
            <Link href="/privacy" className="hover:text-white transition-colors">Privacy Policy</Link>
            <span>MARA Registered Migration Agents</span>
          </div>
        </div>
      </div>
    </footer>
