...
export default function EligibilityCard({
  ...
  return (
    <div
      className={cn(
        "bg-white rounded-xl p-5 border border-cmg-cream-dark border-t-[3px] shadow-[0_2px_12px_rgba(26,24,38,0.05)] hover:shadow-[0_8px_24px_rgba(26,24,38,0.09)] transition-shadow duration-200",
        styles.topBorder
      )}
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start gap-2 mb-1 flex-wrap">
            <p className="font-semibold text-cmg-ink text-sm leading-snug">{title}</p>
            {required && (
