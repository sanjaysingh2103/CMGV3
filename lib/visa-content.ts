...
export const visaContent: Record<string, VisaPageContent> = {
  "skilled-migration": {
    ...
    faqs: [
      ...
      { question: "What happens if my visa application is refused?", answer: "If your skilled visa application is refused, you generally have 21 days to lodge an appeal with the Administrative Review Tribunal (ART, formerly the AAT). ART review fees are around AUD $3,496 and processing typically takes 12–24 months. CMG offers a free refusal assessment to determine whether appeal is your best option or whether re-application with stronger evidence is more strategic." },
      { question: "Do I need to be in Australia to apply for skilled migration?", answer: "No. All three subclasses (189, 190, 491) can be lodged either onshore (inside Australia) or offshore (outside Australia). Many applicants apply from their home country and travel to Australia once the visa is granted. The Department conducts the same assessment regardless of where you are physically located when you lodge." },
  ...
  "employer-sponsored": {
    ...
    faqs: [
      ...
      { question: "What is the Core Skills Income Threshold (CSIT) and TSMIT?", answer: "Effective July 2024, employer-sponsored visas require sponsored workers to earn at least the Core Skills Income Threshold of AUD $73,150 (replacing the older TSMIT). This is the minimum salary — actual market salary rates may be higher for your specific occupation. Sponsors must pay genuine market rate, not just the threshold." },
  ...
  "student": {
    ...
    hero: {
      ...
      bgImage: "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?w=1920&q=80",
    ...
    faqs: [
      ...
      { question: "Can I bring my partner and children on a student visa?", answer: "Yes. Your spouse/de facto partner and dependent children under 18 can be included as secondary 500 visa holders. They must be added to your application (either at lodgement or via subsequent entrant). Partners receive 48 hours/fortnight work rights during semester. Master's and PhD students' partners receive unrestricted work rights. Children can attend school (state school fees apply in most states — NSW and Victoria charge international school fees)." },
    ],
    cta: {
